...
describe User do
  ...
  describe "password ecnryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil on email/passwword mismatch" do
  ...
  describe "microposts associations" do
    ...
    it "should haver the right microposts in the right order" do
